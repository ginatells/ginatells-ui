...
describe('MainPage Component', () => {
  ...
  describe('Character Image', () => {
    it('renders gina\'s  image inside a character div', () => {
  ...
  describe('Question', () => {
    it('renders a Question component', () => {
      const questionOptions = shallowMainPage().find('div#main-page div#question-options-div');
      expect(questionOptions.childAt(0).find('Question').exists()).toBe(true);
    });
  });
